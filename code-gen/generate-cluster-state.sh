...
${IRSA_CLUSTER_AUTOSCALER_ANNOTATION_KEY_VALUE}
...
echo "Initial IRSA_CLUSTER_AUTOSCALER_ANNOTATION_KEY_VALUE: ${IRSA_CLUSTER_AUTOSCALER_ANNOTATION_KEY_VALUE}
...
export IRSA_CLUSTER_AUTOSCALER_ANNOTATION_KEY_VALUE=${IRSA_CLUSTER_AUTOSCALER_ANNOTATION_KEY_VALUE:-''}
...
echo "Using IRSA_CLUSTER_AUTOSCALER_ANNOTATION_KEY_VALUE: ${IRSA_CLUSTER_AUTOSCALER_ANNOTATION_KEY_VALUE}"
...
(
  ...
  set_var "IRSA_CLUSTER_AUTOSCALER_ANNOTATION_KEY_VALUE" "" "${ACCOUNT_BASE_PATH}" "${ENV}/irsa-role/cluster-autoscaler/arn" "${IRSA_TEMPLATE}"
  echo "${IRSA_CLUSTER_AUTOSCALER_ANNOTATION_KEY_VALUE}"

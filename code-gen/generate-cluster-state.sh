...
${IRIA_CLUSTER_AUTOSCALER_ANNOTATION_KEY_VALUE}
...
echo "Initial IRIA_CLUSTER_AUTOSCALER_ANNOTATION_KEY_VALUE: ${IRIA_CLUSTER_AUTOSCALER_ANNOTATION_KEY_VALUE}
...
export IRIA_CLUSTER_AUTOSCALER_ANNOTATION_KEY_VALUE=${IRIA_CLUSTER_AUTOSCALER_ANNOTATION_KEY_VALUE:-''}
...
echo "Using IRIA_CLUSTER_AUTOSCALER_ANNOTATION_KEY_VALUE: ${IRIA_CLUSTER_AUTOSCALER_ANNOTATION_KEY_VALUE}"
...
(
  ...
  set_var "IRIA_CLUSTER_AUTOSCALER_ANNOTATION_KEY_VALUE" "" "${ACCOUNT_BASE_PATH}" "${ENV}/irsa-role/cluster-autoscaler/arn" "${IRSA_TEMPLATE}"

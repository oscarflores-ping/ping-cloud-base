...
#                                  |                                                    |
# PF_RDS_SECRET_PATH               | Path to the Secret Containing RDS Connection       |
#                                  | Details for the PingFederate Provisioning Database |
#                                  |                                                    |
...
${ENRICHMENT_BOOTSTRAP_IMAGE_TAG}
${OPENSEARCH_IMAGE_TAG}
${OPENSEARCH_DASHBOARDS_IMAGE_TAG}
${LOGSTASH_EXPORTER_IMAGE_TAG}
${LOGSTASH_IMAGE_TAG}
...
${IRSA_LOGSTASH_COMPLIANCE_ANNOTATION_KEY_VALUE}
...
echo "Initial PF_RDS_SECRET_PATH: ${PF_RDS_SECRET_PATH}"
...
echo "Initial IRSA_BOOTSTRAP_ANNOTATION_KEY_VALUE: ${IRSA_BOOTSTRAP_ANNOTATION_KEY_VALUE}"
...
echo "Initial IRSA_LOGSTASH_COMPLIANCE_ANNOTATION_KEY_VALUE: ${IRSA_LOGSTASH_COMPLIANCE_ANNOTATION_KEY_VALUE}"
...
echo "Initial IRSA_KARPENTER_ANNOTATION_KEY_VALUE: ${IRSA_KARPENTER_ANNOTATION_KEY_VALUE}"
...
export IRSA_BOOTSTRAP_ANNOTATION_KEY_VALUE=${IRSA_BOOTSTRAP_ANNOTATION_KEY_VALUE:-''}
...
export IRSA_LOGSTASH_COMPLIANCE_ANNOTATION_KEY_VALUE=${IRSA_LOGSTASH_COMPLIANCE_ANNOTATION_KEY_VALUE:-''}
...
export PF_RDS_SECRET_PATH="${PF_RDS_SECRET_PATH:-ssm://aws/reference/secretsmanager//pcpt/ping-federate/dbserver}"
...
echo "Using PF_RDS_SECRET_PATH: ${PF_RDS_SECRET_PATH}"
...
echo "Using IRSA_LOGSTASH_COMPLIANCE_ANNOTATION_KEY_VALUE: ${IRSA_LOGSTASH_COMPLIANCE_ANNOTATION_KEY_VALUE}"
...
(
  ...
  set_var "IRSA_BOOTSTRAP_ANNOTATION_KEY_VALUE" "" "${ACCOUNT_BASE_PATH}" "${ENV}/irsa-role/bootstrap/arn" "${IRSA_TEMPLATE}"
  ...
  set_var "IRSA_LOGSTASH_COMPLIANCE_ANNOTATION_KEY_VALUE" "" "${ACCOUNT_BASE_PATH}" "${ENV}/irsa-role/logstash-compliance/arn" "${IRSA_TEMPLATE}"
  ...
  echo "Using IRSA_PING_ANNOTATION_KEY_VALUE: ${IRSA_PING_ANNOTATION_KEY_VALUE}"
  echo "Using IRSA_BOOTSTRAP_ANNOTATION_KEY_VALUE: ${IRSA_BOOTSTRAP_ANNOTATION_KEY_VALUE}"
  echo "Using IRSA_KARPENTER_ANNOTATION_KEY_VALUE: ${IRSA_KARPENTER_ANNOTATION_KEY_VALUE}"
  echo "Using IRSA_INGRESS_ANNOTATION_KEY_VALUE: ${IRSA_INGRESS_ANNOTATION_KEY_VALUE}"
  echo "Using NLB_NGX_PUBLIC_ANNOTATION_KEY_VALUE: ${NLB_NGX_PUBLIC_ANNOTATION_KEY_VALUE}"
  echo "Using CLUSTER_ENDPOINT: ${CLUSTER_ENDPOINT}"
  ...
  for app_repo in ${PROFILE_REPO_MIRRORS[@]}; do
    ...
    configure_profile_repo_script="${PROFILE_REPO_MIRROR_DIR}/${app_repo}/configure-profile-repo.sh"
    if test -f "${configure_profile_repo_script}"; then
